...
void main() {
  ...
  group('JustScrollArea Physics & Smooth Engine Tests', () {
    ...
    testWidgets('Renders scroll area child content correctly', (WidgetTester tester) async {
    ...
    testWidgets('Responds to PointerScrollEvent and drives smooth scroll offset', (WidgetTester tester) async {
    ...
    testWidgets('Detects trackpad signal profile and uses 1:1 responsive lerp factor', (WidgetTester tester) async {
      final controller = ScrollController();
      await tester.pumpWidget(
        buildTestScrollArea(
          controller: controller,
    ...
    testWidgets('Scroll to top button appears when threshold exceeded and resets scroll', (WidgetTester tester) async {
      final controller = ScrollController();
      await tester.pumpWidget(
        buildTestScrollArea(
          controller: controller,
