...
Widget buildJustScrollAreaDefaultUseCase(BuildContext context) {
  final bool fadeEdges = context.knobs.boolean(
    label: 'Fade Edges',
    initialValue: true,
  );
  final bool showScrollbar = context.knobs.boolean(
    label: 'Show Scrollbar',
    initialValue: true,
  );
  final bool scrollToTopButton = context.knobs.boolean(
    label: 'Scroll to Top Button',
    initialValue: true,
  );
  final bool smoothScroll = context.knobs.boolean(
    label: 'Smooth Scroll (Lenis)',
    initialValue: true,
  );
  final double lerpFactor = context.knobs.double.slider(
    label: 'Lerp Factor',
    initialValue: 0.10,
    min: 0.01,
    max: 0.5,
  );
  final double wheelMultiplier = context.knobs.double.slider(
    label: 'Wheel Multiplier',
    initialValue: 1.0,
    min: 0.5,
    max: 3.0,
  );
  final double maxHeight = context.knobs.double.slider(
  ...
  activityData =
      ...
      >[
        ...
        (
          ...
          badgeText: 'Release',
          title: 'JustUI Core v0.14.0 Published',
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          JustScrollArea(
            ...
            child: Column(
              children: .generate(activityData.length, (int index) {
                final ({
                  String badgeText,
                  Color iconColor,
                  String subtitle,
