// justui-meta: registry=f7236cfb5edc123e99b406ffa26ebaf4573264b678853f30b5b5beec69c75bd0 local=af9012a3e47f0984d3042d1ac1668baa4cc8457704dcd9481ddd96389b1a7e63
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: presetTokens.showsDefaultBorder
                                ? .all(color: colors.textPrimary, width: 2.0)
                                : null,
                          ),
                        ),

                        // 2. Active Track (Filled)
                        Positioned(
                          left: _isRange ? startPosition : 0.0,
                          width: _isRange
                              ? (endPosition - startPosition).clamp(
                                  0.0,
                                  totalWidth,
                                )
                              : (startPosition + thumbSize / 2).clamp(
                                  0.0,
                                  totalWidth,
                                ),
                          child: Container(
