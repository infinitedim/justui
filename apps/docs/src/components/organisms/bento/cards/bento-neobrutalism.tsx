    ...
    >
      <div>
        <div className="flex items-center justify-between gap-4">
          <Badge variant="outline">PHYSICS & CALCULUS</Badge>
          <span className="text-muted font-mono text-xs">0ms Frame-Lock</span>
        </div>
        ...
        <div className="border-border bg-background/60 mt-4 grid grid-cols-1 gap-4 rounded-(--just-radius-md) border p-4 sm:grid-cols-2">
          ...
          <div className="border-border/80 flex flex-col items-center justify-center gap-3 rounded border border-dashed p-4">
            ...
            <div className="text-muted flex gap-2 font-mono text-[10px]">
          ...
          <div className="border-border/80 flex flex-col items-center justify-center gap-3 rounded border border-dashed p-4">
            ...
            <button
              ...
              className={cn(
                'border-foreground relative h-8 w-16 rounded-full border-[2.5px] transition-colors',
            ...
            >
              <span
                style={{
                  ...
                  top: `${padding}px`,
                  left: switchOn
                    ? `calc(100% - ${thumbDiameter + padding + 1}px)`
                    : `${padding}px`,
                }}
                className="border-foreground bg-foreground absolute rounded-full border-[1.5px] transition-all duration-150"
              />
            </button>
